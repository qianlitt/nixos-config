{
  wayland.windowManager.hyprland.settings = {
    window_rule = [
      ...
      { match.class = "gcr-prompter"; center = true; } # GNOME 下的安全组件
      { match.class = "gcr-prompter"; float = true; }
      ...
      { match.class = "^jetbrains-.*$"; match.float = "1"; match.title = "^$|^\s$|^win\d+$"; no_initial_focus = true; }
