...
local function exe(key, env)
    ...
    elseif (context.input == "/biying" or context.input == "/bing" or context.input == "/biyk" or context.input ==
        "/htxk") then
    ...
    elseif (context.input == "/wangpan" or context.input == "/whpj" or context.input == "/mbia") then
        ...
        context:clear()
    elseif (context.input == "/genda" or context.input == "/gfda" or context.input == "/piua" or context.input ==
        "/muyi" or context.input == "/emon") then
